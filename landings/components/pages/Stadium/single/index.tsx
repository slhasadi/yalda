...
import { Item, NewsTypes } from "../../../../interfaces/interfaces";
...
const SingleNews: FC<Props> = ({ data }) => {
  ...
  return (
    <Container>
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mt-[100px]">
        <div className="order-2 lg:order-1 col-span-1 lg:col-span-3 cursor-pointer">
          {cookies.data?.ads_banner_type === "soroush_api" ? (
            ...
            >
              {NextImageProxy(banner, 575, 320, "soroush banner")}
            </div>
          ) : (
